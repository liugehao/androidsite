...
class Archive(models.Model):
    ...
    version = models.CharField(u'版本', max_length=40)
    category = models.CharField(u'类别', max_length=30)
    ...
    screen = models.CharField(u'分辨率', max_length=255)
...
class Upfile(models.Model):
    ...
    path = models.FileField(u'文件', upload_to='media', max_length=255)
